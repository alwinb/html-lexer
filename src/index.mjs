...
// The contentMap determines the lexer state
// to be used after particular start tags.
...
// ---------------------------
// Legacy character references are named character references that may 
