...
var NONTERMS = 	/^&([AEIOUYaeiouy]?acute|[AEIOUaeiou]grave|[ANOano]tilde|[Oo]slash|[Cc]?cedil|brvbar|curren|divide|frac(?:12|14|34)|iquest|middot|plusmn|[AEIOUaeiou]circ|(?:AE|ae|sz)lig|[Aa]ring|[lr]aquo|iexcl|micro|pound|THORN|thorn|times|[AEIOUaeiouy]uml|COPY|copy|cent|macr|nbsp|ord[fm]|para|QUOT|quot|sect|sup[123]|AMP|amp|ETH|eth|REG|reg|deg|not|shy|uml|yen|GT|gt|LT|lt)(;|.*)/
